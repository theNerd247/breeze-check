...
-- Generated on: 2018-03-12 05:18:16.526555354 UTC
    ...
    case x of
        ...
        WaitingCreation y0 y1 ->
            Json.Encode.object
                ...
                , ( "contents", Json.Encode.list [ Json.Encode.int y0, Json.Encode.string y1 ] )
                ]
...
decodeNewPersonInfo =
    decode NewPersonInfo
        ...
        |> required "newCurrentChurch" string
...
encodeNewPersonInfo x =
    Json.Encode.object
        ...
        , ( "newCurrentChurch", Json.Encode.string x.newCurrentChurch )
...
decodeEventInfo =
    decode EventInfo
        |> required "eid" string
        |> required "ename" string

encodeEventInfo : EventInfo -> Json.Encode.Value
encodeEventInfo x =
    Json.Encode.object
        [ ( "eid", Json.Encode.string x.eid )
        , ( "ename", Json.Encode.string x.ename )
        ]